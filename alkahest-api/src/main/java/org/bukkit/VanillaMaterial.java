...
public enum VanillaMaterial implements Material {
    ...
    private VanillaMaterial(final int id) {
        this(id, MaterialData.class);
    }

    private VanillaMaterial(final int id, final Class<?> data) {
        this.id = id;
        this.data = data;
        // literal avoids circular init (Material statics point at VanillaMaterial constants)
        this.legacy = this.name().startsWith("LEGACY_");
        ...
        this.itemType = Suppliers.memoize(() -> {
            VanillaMaterial material = this;
            if (isLegacy()) {
                material = (VanillaMaterial) Bukkit.getUnsafe().fromLegacy(new MaterialData(this), true);
            }
        ...
        this.blockType = Suppliers.memoize(() -> {
            VanillaMaterial material = this;
            if (isLegacy()) {
                material = (VanillaMaterial) Bukkit.getUnsafe().fromLegacy(new MaterialData(this), false);
            }
